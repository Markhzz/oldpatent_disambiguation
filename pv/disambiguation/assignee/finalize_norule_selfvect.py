...
flags.DEFINE_string('input', 'exp_out/assignee/run_5', '')
flags.DEFINE_string('assignee_name_mentions', 'exp_out/assignee_mentions.records.pkl', '')

flags.DEFINE_string('output', 'exp_out/disambiguation_norule_selfvect.tsv', '')
