...
from pv.disambiguation.assignee.model_dup import AssigneeModel

FLAGS = flags.FLAGS

flags.DEFINE_string('assignee_canopies', 'exp_out/duplicate/assignee_mentions.canopies.pkl', '')
flags.DEFINE_string('assignee_mentions', 'exp_out/duplicate/assignee_mentions.records.pkl', '')
...
flags.DEFINE_string('run_id', 'run_2', 'data path')
...
flags.DEFINE_integer('chunk_size', 1000, '')
