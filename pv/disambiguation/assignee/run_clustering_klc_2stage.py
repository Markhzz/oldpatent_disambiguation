...
import logging as export_logging
from absl import logging
from grinch.agglom import Agglom
from grinch.model import LinearAndRuleModel

os.chdir('/kellogg/data/patents/code/assignee_clustering')
print('set up the directory')
...
flags.DEFINE_string('assignee_canopies', '/kellogg/data/patents/output/assignee_mentions_2stage.canopies.pkl', '')
flags.DEFINE_string('assignee_mentions', '/kellogg/data/patents/output/assignee_mentions_2stage.records.pkl', '')
...
flags.DEFINE_string('outprefix', '/kellogg/data/patents/output/', 'data path')
flags.DEFINE_string('run_id', 'run_33', 'data path')
...
# export_logging.basicConfig(filename='/kellogg/data/patents/output/clustering_stcy.log', encoding='utf-8')
