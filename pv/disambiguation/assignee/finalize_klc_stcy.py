...
flags.DEFINE_string('input', '/kellogg/data/patents/output/assignee/run_22', '')
flags.DEFINE_string('assignee_name_mentions', '/kellogg/data/patents/output/assignee_mentions.records.pkl', '')
flags.DEFINE_string('path', '/kellogg/data/patents/patent_text/', '')
flags.DEFINE_string('output', '/kellogg/data/patents/output/disambiguation.tsv', '')
...
def main(argv):
    ...
    with open(FLAGS.output + 'assignee_disambiguation_stcy.pkl', 'wb') as fout:
    ...
    final_output['entity_id'] = final_entity_id
    final_output.to_csv(FLAGS.feature_out + 'disambiguation_output.csv')
