...
flags.DEFINE_string('assignee_canopies', '/kellogg/data/patents/output/assignee_mentions.canopies.pkl', '')
flags.DEFINE_string('assignee_mentions', '/kellogg/data/patents/output/assignee_mentions.records.pkl', '')
